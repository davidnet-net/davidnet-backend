export const auditLogTemplateEmail = `<!doctype html>
<html>
    <body>
        <h1>Auditlog</h1>
        <p>{{message}}</p>
        <a class="verify-button" href="https://account.davidnet.net/manage/security/audit">View all audit logs</a>
        <div class="SmallSpacer"></div>

        <p>
            If this was not you. Take action to secure your account, visit: <a class="verify-button" href="https://account.davidnet.net/manage/security">Account security</a>.
        </p>
